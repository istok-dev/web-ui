  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: 'text-body-md font-medium text-[#2c2c2c]',
        nav: 'flex flex-1 items-center gap-1 z-2',
        button_previous: `
          flex absolute left-3 top-3 h-9 w-9 cursor-pointer items-center
          justify-center rounded-md border border-[#E5E0D8] bg-neutral-50 p-0
          opacity-100 hover:bg-[#F2F0EB] hover:opacity-100
        ...
        day_button: cn(
          ...
          'cursor-pointer text-[#2c2c2c]',
        ),
        range_start:
          'day-range-start rounded-sm bg-[#8F9F83] text-white hover:bg-[#8F9F83] hover:text-white',
        range_end:
          'day-range-end rounded-sm bg-[#8F9F83] text-white hover:bg-[#8F9F83] hover:text-white',
